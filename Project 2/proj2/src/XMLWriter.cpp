...
struct CXMLWriter::SImplementation {
    ...
    std::vector<std::string> openElements; // Stack of currently open element names
...
// WriteEntity writes out the supplied XML entity.
bool CXMLWriter::WriteEntity(const SXMLEntity &entity) {
    ...
    switch(entity.DType) {
        ...
        case SXMLEntity::EType::EndElement:
            ...
            if (!DImplementation->openElements.empty() &&
                DImplementation->openElements.back() == entity.DNameData)
            {
